...
// This component renders the contact page with a header, contact details, map, and a contact form.
        ...
        <div>
            ...
            <div className="contact-details">
                <div className="map-section">
                    {/* Embed Google Map showing the business location */}
                    {/* Ensures the map is responsive and maintains an aspect ratio */}
                    <iframe
                ...
                <div className="info-section">
                    ...
                    <h3>EMAIL</h3>
                    <p>example@buke.com</p>
                    <h3>TEL</h3>
                    <p>(123) 456-7890</p>
                    <h3>HOURS</h3>
                    <p>Mon–Sun 11am – 9:30pm</p>
                    <h3>ADDRESS</h3>
                    <p>123 Random Street<br />Buffalo, NY 12345</p>
                </div>
